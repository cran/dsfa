...
dcop_unrot_cpp <- function(u, v, p, distr_cop, deriv_order, tri, logp) {
    .Call('_dsfa_dcop_unrot_cpp', PACKAGE = 'dsfa', u, v, p, distr_cop, deriv_order, tri, logp)
}

dcop_cpp <- function(u, v, p, distr_cop, rot, deriv_order, tri, logp) {
    .Call('_dsfa_dcop_cpp', PACKAGE = 'dsfa', u, v, p, distr_cop, rot, deriv_order, tri, logp)
}
