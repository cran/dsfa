...
dcomperr_mv<-function(x1=0, mu1=0, sigma_v1=1, par_u1=1, s1=-1,
  ...
  #Margin 1
  fy1<-dcomperr(x=x1, mu=mu1, sigma_v=sigma_v1, par_u=par_u1, s=s1, family=family_mv[1], deriv = deriv, log.p = TRUE)
  Fy1<-pcomperr(q=x1, mu=mu1, sigma_v=sigma_v1, par_u=par_u1, s=s1, family=family_mv[1], deriv = deriv, log.p = FALSE)

  #Margin 2
  fy2<-dcomperr(x=x2, mu=mu2, sigma_v=sigma_v2, par_u=par_u2, s=s2, family=family_mv[2], deriv = deriv, log.p = TRUE)
  Fy2<-pcomperr(q=x2, mu=mu2, sigma_v=sigma_v2, par_u=par_u2, s=s2, family=family_mv[2], deriv = deriv, log.p = FALSE)
...
pcomperr_mv<-function(q1=0, mu1=0, sigma_v1=1, par_u1=1, s1=-1,
  ...
  #Margin 1
  Fy1<-pcomperr(q=q1, mu=mu1, sigma_v=sigma_v1, par_u=par_u1, s=s1, family=family_mv[1], deriv = 0, log.p = FALSE)

  #Margin 2
  Fy2<-pcomperr(q=q2, mu=mu2, sigma_v=sigma_v2, par_u=par_u2, s=s2, family=family_mv[2], deriv = 0, log.p = FALSE)
...
rcomperr_mv<-function(n, mu1=0, sigma_v1=1, par_u1=1, s1=-1,
  ...
  #Margin 1
  y1<-qcomperr(p=obs[,1], mu=mu1, sigma_v=sigma_v1, par_u=par_u1, s=s1, family=family_mv[1])

  #Margin 2
  y2<-qcomperr(p=obs[,2], mu=mu2, sigma_v=sigma_v2, par_u=par_u2, s=s2, family=family_mv[2])
